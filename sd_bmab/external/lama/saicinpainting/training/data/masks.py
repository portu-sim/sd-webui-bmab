...
# from sd_bmab.external.lama.saicinpainting.evaluation.masks.mask import SegmentationMask
from sd_bmab.external.lama.saicinpainting.utils import LinearRamp
