...
class Parameters(object):
	def __init__(self) -> None:
		...
		self.params = [
			...
			('module_config.face_detailing.prompt0', ''),
			('module_config.face_detailing.negative_prompt0', ''),
			('module_config.face_detailing.prompt1', ''),
			('module_config.face_detailing.negative_prompt1', ''),
			('module_config.face_detailing.prompt2', ''),
			('module_config.face_detailing.negative_prompt2', ''),
			('module_config.face_detailing.prompt3', ''),
			('module_config.face_detailing.negative_prompt3', ''),
			('module_config.face_detailing.prompt4', ''),
			('module_config.face_detailing.negative_prompt4', ''),
